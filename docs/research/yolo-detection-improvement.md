...
当前使用 `yolo26n.pt` (YOLO26，2026年新版本) 进行人物检测，存在以下问题：

> ⚠️ **勘误**：YOLO26 是 2026 年新发布的版本，但根据最新对比，YOLO11s/YOLO12s 在多个指标上**超过** YOLO26s。
...
|------|---------|--------|----------|----------|
| YOLO26n (当前) | ~55% | 2.5M | 最快 | - |
| **YOLO11s** | ~57% | 9.4M | 快 | **推荐** |
| **YOLOv12s** | ~61.8% | 9.3M | 快 | **高精度推荐** |
| YOLO8m | 63.3% | 26.0M | 中 | 精度优先 |

**注意**：根据最新对比，YOLO11s/YOLOv12s 在多个指标上优于 YOLO26s。
